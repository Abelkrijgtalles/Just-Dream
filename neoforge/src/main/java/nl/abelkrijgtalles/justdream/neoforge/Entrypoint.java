package nl.abelkrijgtalles.justdream.neoforge;
...
import nl.abelkrijgtalles.justdream.neoforge.specialentrypoints.EntrypointClient;
import nl.abelkrijgtalles.justdream.neoforge.specialentrypoints.EntrypointDedicatedServer;
import nl.abelkrijgtalles.justdream.neoforge.util.multiloader.NeoForgeItemHandler;
...
public class Entrypoint {
    public Entrypoint(IEventBus modEventBus, ModContainer modContainer) {
        ...
        JustDream.LOGGER.info("Running on NeoForge.");
    ...
    @EventBusSubscriber(modid = JustDream.MOD_ID, bus = EventBusSubscriber.Bus.MOD, value = Dist.CLIENT)
