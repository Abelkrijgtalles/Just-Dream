package nl.abelkrijgtalles.justdream.neoforge.util.multiloader;
...
import nl.abelkrijgtalles.justdream.item.BallsItem;
...
public class NeoForgeItemHandler {
    ...
    public static final DeferredRegister.Items ITEMS = DeferredRegister.createItems(JustDream.MOD_ID);
    ...
    private static ResourceKey<CreativeModeTab> homemadeInventoryGroupToMojangStandard(InventoryGroups group) {
        ...
        JustDream.LOGGER.error("I've somehow passed an homemade inventory group that's not part of the enum. Returning null.");
        return null;
    ...
    private static Item itemFromItemPropertyType(ItemPropertyType itemPropertyType) {
        ...
        JustDream.LOGGER.error("I've somehow passed an item property type that's not part of the enum. Returning null.");
        return null;
