package nl.abelkrijgtalles.justdream.forge;
...
import nl.abelkrijgtalles.justdream.forge.specialentrypoints.EntrypointClient;
import nl.abelkrijgtalles.justdream.forge.specialentrypoints.EntrypointDedicatedServer;
import nl.abelkrijgtalles.justdream.forge.util.multiloader.ForgeItemHandler;
...
public class Entrypoint {
    public Entrypoint() {
        ...
        JustDream.LOGGER.info("Running on Forge.");
    ...
    @Mod.EventBusSubscriber(modid = JustDream.MOD_ID, bus = Mod.EventBusSubscriber.Bus.MOD, value = Dist.CLIENT)
